...
# Imports
import argparse
from src.utils import print_init, print_datasets, print_gnns, final_evaluation_same_domain, eval_one_attack, final_evaluation_same_domain_2
...
def main(args):
    ...
    final_evaluation_same_domain_2(experiments)
