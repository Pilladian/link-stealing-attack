...
\input{src/Chapters/chapter1.tex} % Introduction

\input{src/Chapters/chapter2.tex} % Related Work

\input{src/Chapters/chapter3.tex} % Background

\input{src/Chapters/chapter4.tex} % Attacks

\input{src/Chapters/chapter5.tex} % Implementation
...
\input{src/Appendices/Appendix} % tables
