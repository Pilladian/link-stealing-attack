...
\abstract{
  ...
  Depending on data sets and the Graph Neural Network model we achieve up to $0.896$ F1-Score while having an average performance of $0.782$ F1-Score regarding all our attacks.
