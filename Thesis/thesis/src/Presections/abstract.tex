...
\abstract{
  ...
  Depending on datasets and the graph neural network model we achieve up to $0.8909$ F1-Score while having an average performance of $0.7770$ F1-Score regarding all our attacks.
