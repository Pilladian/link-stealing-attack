...
\abstract{
  ...
  Since transductive trained Graph Neural Networks can only handle fixed graphs, they are not able to generalize to unseen nodes and therefore are limited.
  ...
  Depending on data sets and the Graph Neural Network model we achieve up to $0.899$ F1-Score while having an average performance of $0.782$ F1-Score regarding all our attacks.
