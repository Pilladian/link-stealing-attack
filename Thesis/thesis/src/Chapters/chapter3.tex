\chapter{Background}
  ...
  \section{Neural Networks}
    ...
    \subsection*{Train a Graph Neural Network}
      ...
      We denote $workplace$ as label, we want to predict and $V = v_{workplace} \cup v_{unknown}$ as set of nodes, containing every node, no matter whether the label is given or not.
      ...
      Depending on the type of GNN, this aggregation function $neighborhood()$ can be different.
      ...
      \subsubsection*{Transductive Learning}
        ...
        More precisely, let $G = (V, E)$ be a graph we want to train our GNN on.
        $V = v_{workplace} \cup v_{unknown}$ contains every node, no matter whether the label is given or not.
