\chapter{Evaluation}
    ...
    \section{Attack Performance}
        ...
        \subsection*{Attack 2}
            ...
            With rising amount of known edges, the attack performance grows, leading to an improvement up to \TODO{$0.06$} F1-Score, while comparing the baseline performance with the results of attacks with known edges.
