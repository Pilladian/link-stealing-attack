\chapter{Introduction}
	...
	\section{Motivation}
		...
		Graphs consist of nodes and edges and can be used to model data in almost every domain, e.g. in social networks \TODO{cite}, chemical networks \TODO{cite} or healthcare analytics \TODO{cite}.
		...
		A Graph Neural Network can be trained in different ways, depending on the purpose it will be in the future.
